...
;   * use that chunk's forward_ptr as the place to allocate
;   * store backward_ptr, user data and size
;   * store forward_ptr based on size
;   * update main_ptr to point to this chunk
;   * return a pointer to this chunk
; * free process:
;   * get a pointer to a chunk
;   * get its backwards and forwards chunks
;   * link them together
;   * if backwards chunk missing (1st item was freed), memcopy the forward chunk to $d000
...
wHeapData:: ds $1000 ; todo: turn to $1000 after conversion
